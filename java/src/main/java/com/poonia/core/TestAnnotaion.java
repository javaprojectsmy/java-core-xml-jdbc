	...
	public static void main(String[] args) {
		...
		try {
			...
			if(field.isAnnotationPresent(Inject.class)){
				...
				MinMaxArray<Double> minMaxArrayImpl=new MinMaxArrayImpl<Double>(3.4,5.6,7.8,8.9,6.3);
				Object object=useAnnotation.newInstance();
				Method method=useAnnotation.getMethod("setMinMaxArray",MinMaxArray.class);
		...
		} catch (NoSuchFieldException | SecurityException |InstantiationException|IllegalAccessException | NoSuchMethodException |IllegalArgumentException |InvocationTargetException e) {
