...
@Component
@Transactional
public class SpringHibCriteriaQueriesDAOImpl implements
		SpringHibernateCriteriaQuriesDAO {
	...
	public void criteria1() {
	 ...
	 ProjectionList columns=Projections.projectionList().add(Projections.property("name")).add(Projections.property("address.city"));
