...
public class HibernateClient {
	...
	/* Customer customer=new Customer();
	 customer.setName("Yashwant");
	 customer.setAge(new Date());
     dao.add(customer);*/
	 ...
	 */
	 ...
	 /*Customer customers[]={new Customer("Name1",new Date()),
			 new Customer("Name2",new Date()),
			 new Customer("Name3",new Date()),
			 new Customer("Name4",new Date())
	 };*/
	 Customer customer=new Customer("Aman",new Date());
	 Address address=new Address(3233,"WhiteField","Blore","karna","India",560390,2);
	 customer.setAddress(address);
	/* List<Contacts> ct=new ArrayList<Contacts>();
	 ct=customer.getList();
	...
	dao.add(customer);
	 Customer customer1=dao.findByID(14);
	 dao.executeBatch(customers);
	 System.out.println();
	 System.out.println(customer1+" "+customer1.getAddress());*/
	 dao.add(customer);
